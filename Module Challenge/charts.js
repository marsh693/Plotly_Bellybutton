...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var samplesFilter = samplesArrary.filter((object) => object.id == sample);
   ...
   var metaFilter = metadata.filter((object) => object.id == sample);
    ...
    var gaugeData = [
      {
        value: washingFreq,
        title: {text:'Belly Button Washing Frequency<br>Number of Scrubs per Week'},
        type: 'indicator',
        mode: 'gauge+number',
        gauge:
        {
